...
class SentenceDataset(Dataset):
    ...
    def __getitem__(self, index):
        fwd_input = self.fwd_input[index]
        fwd_output = self.fwd_output[index]
        bwd_input = self.bwd_input[index]
        bwd_output = self.bwd_output[index]
        x_len = self.length[index]

        return fwd_input, fwd_output, bwd_input, bwd_output, x_len
